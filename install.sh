#!/usr/bin/env sh
# Universal installer for cognis-devbox. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cognis-devbox.git"
echo "Installing cognis-devbox ..."
...
echo "Done. Run: cognis-devbox --help"
